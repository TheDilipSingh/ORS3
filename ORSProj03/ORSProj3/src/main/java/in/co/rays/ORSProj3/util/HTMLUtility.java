...
import in.co.rays.ORSProj3.dto.DropdownList;
...
public class HTMLUtility {
	...
	{
		StringBuffer sb=new StringBuffer("<select class='custom-select custom-select-md border-left-0' style='padding-left: 3px;' name='" + name + "'>");
