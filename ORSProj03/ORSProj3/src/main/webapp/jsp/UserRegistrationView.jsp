<%@page import="in.co.rays.ORSProj3.controller.UserRegistrationCtl"%>
...
<form action="<%=ORSView.USER_REGISTRATION_CTL %>" method="post" class="col-12 bg-white px-4 py-4 mb-4">
...
<button type="submit" name="operation" value="<%=UserRegistrationCtl.OP_SIGN_UP %>" class="btn btn-primary text-uppercase btn-block">Sign up</button>
<button type="submit" name="operation" value="<%=UserRegistrationCtl.OP_RESET %>" class="btn btn-warning text-uppercase btn-block">Reset</button>
