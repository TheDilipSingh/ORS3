<%@page import="in.co.rays.ORSProj3.controller.MyProfileCtl"%>
...
<form action="<%=ORSView.MY_PROFILE_CTL %>" method="post" class="col-12 bg-white px-4 py-4 mb-4">
...
<input type="text" class="form-control" placeholder="Enter Email id" id="email" readonly name="login" value="<%=DataUtility.getStringData(dto.getLogin()) %>">
</div>
...
<button type="submit" name="operation" value="<%=MyProfileCtl.OP_SAVE %>" class="btn btn-success text-uppercase btn-block">Save</button>
<button type="submit" name="operation" value="<%=MyProfileCtl.OP_CHANGE_MY_PASSWORD %>" class="btn btn-warning text-uppercase btn-block">Change Password</button>
